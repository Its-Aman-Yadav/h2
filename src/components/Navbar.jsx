...
export default function FloatingNavbar() {
  ...
  return (
    <motion.div
      ref={navbarRef}
      className="fixed z-50 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white px-6 py-3 rounded-full cursor-move shadow-lg backdrop-blur-sm bg-opacity-90"
    ...
    >
      <nav className="flex items-center justify-between w-full">
        ...
        <div className="flex space-x-6 mr-10 ml-10 items-center mx-auto">
          {['Home', 'About', 'Explore'].map((item) => (
            <motion.a
              ...
              className="text-sm font-medium hover:text-yellow-100 transition-colors duration-200"
        ...
        {/* "Get in Touch" Button */}
        <motion.button
          className="bg-white text-orange-600 font-medium px-4 py-2 rounded-full shadow-md hover:bg-orange-100 transition-colors duration-200"
